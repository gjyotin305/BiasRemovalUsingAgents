...
Output Format: Answer in "yes": if over representation is there or "no": if balanced representation.
"""
...
Output Format: Answer in "yes": if present or "no": if not present.
"""
